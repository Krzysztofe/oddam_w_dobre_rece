export const URL_allOrganizatons = `https://my-json-server.typicode.com/Krzysztofe/oddam_api/db`
...
export const URL_user_POST = 'https://authentication-cl-default-rtdb.europe-west1.firebasedatabase.app/users.json'